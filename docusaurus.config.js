...
const config = {
  ...
  organizationName: 'seb646', // Usually your GitHub org/user name.
  projectName: 'surveillance.fyi', // Usually your repo name.
  trailingSlash: false,
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/seb646/surveillance.fyi',
            label: 'GitHub',
            position: 'right',
          },
        ],
